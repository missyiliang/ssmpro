<%-- User: lins  Date: 2019-7-15 16:44 IDE.--%>
...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="common/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="common/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="common/css/animate.css" rel="stylesheet">
    <link href="common/css/style.css?v=4.1.0" rel="stylesheet">
</head>
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="common/img/profile_small.jpg" /></span>
...
<script src="common/js/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="common/js/hplus.js?v=4.1.0"></script>
<script type="text/javascript" src="common/js/contabs.js"></script>
